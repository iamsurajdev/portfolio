...
import BlogImage from "../Assets/images/projectPictures/Blog.png";
      ...
      <div className={classes.component}>
        ...
        <div className={classes.sideNoteDiv}>
          <p>
            ...
            programmer and I am super proud of Dedlok. I am not the only creator
            of all this blogs and posts.
          </p>
        </div>
